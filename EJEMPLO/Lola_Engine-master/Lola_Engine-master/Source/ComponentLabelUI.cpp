...
ComponentLabelUI::~ComponentLabelUI()
{
...
void ComponentLabelUI::AddResource(Resource *res)
{
	res->IncrReferences();
	resource = (ResourceTexture*)res;
}

void ComponentLabelUI::SetText()
{
	App->font_manager->CreateTextureFromText(resource);
}

void ComponentLabelUI::ShowEditorInfo()
{
...
bool ComponentLabelUI::Save(JSONParser &go)
{
...
bool ComponentLabelUI::Load(JSONParser &comp)
{
